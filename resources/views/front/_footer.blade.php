        ...
        <div class="col-xl-2 col-md-5 order-md-1 order-xl-4 col-sm-6">
          <div class="footer-widget">
            ...
            <ul>
              ...
              <li>
                <span>Email:</span>
                <a href="mailto:surajitbasak109@gmail.com" class="__cf_email__">surajitbasak109@gmail.com</a>
              </li>
              <li>
                <span>Location:</span>
                India
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="text-center">
            <p>Designed & Developed By <a href="surajitbasak109.github.com" rel="nofollow" target="_blank">Surajit Basak</a></p>
          </div>
        </div>
      </div>
    </div>
